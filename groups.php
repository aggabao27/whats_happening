...
<head>
  ...
  <!-- Updated the Navigation Bar and Footer -->
...
<body>
  ...
  <!-- Updated the main and changed display to Our Community Groups -->
  <!-- Changed the name of each person to Group Name as well as their title to GROUP TYPE-->
  <main id="main">
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <?php
          // Connect to sql database named whats_happening
            ...
            // Select/retrieve all columns in table named Groups
            $myGroupsQuery = "SELECT * FROM Groups";
            // sends the query to the database and returns a result object that can be used to fetch the results of the query. From database, my query
            $result = mysqli_query($connect, $myGroupsQuery);

            // Print out the groups to populate the page. This code makes sure the format is still the same as assignment 2, but in a more efficient way of coding it.
